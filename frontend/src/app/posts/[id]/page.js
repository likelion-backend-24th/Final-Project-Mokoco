...
export default async function PostDetailPage({ params }) {
  ...
  const userEmail =
      cookieStore.get("user_email")?.value ?? null;
  const accessToken =
      cookieStore.get("access_token")?.value ?? null;

  const [{ post, error }, proposals, isAdmin] =
      await Promise.all([
        getPost(id),
        getProposals(id),
              ...
              <div className="space-y-6">
                <div className="dashboard-card">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    >
                      ...
                      <h1 className="mt-3 text-[28px] font-extrabold tracking-[-0.03em] text-slate-950">
                        {post.title}
                      </h1>
                    </div>
                ...
                <span>
                  ...
                  <RichTextRenderer
                      ...
                      className="mt-6 text-[15px] leading-relaxed text-slate-700"
                  />
