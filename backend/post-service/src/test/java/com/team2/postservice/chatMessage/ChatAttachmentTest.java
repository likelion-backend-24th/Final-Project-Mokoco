...
class ChatAttachmentTest {
    ...
    @Test void detectsActualImageRatherThanDeclaredMimeAndCleansRollback() throws Exception {
        ...
        ChatMessageResponse result = service.upload(1L, 2L, new MockMultipartFile("file", "../photo.png", "text/plain", png));
    ...
    @Test void acceptsMp4ContainerDetectedFromFileBytes() throws Exception {
        ...
        ChatMessageResponse result = service.upload(1L, 2L, new MockMultipartFile("file", "a8.mp4", "video/mp4", mp4));
    ...
    @Test void deletedAttachmentCannotBeDownloaded() {
        ChatMessage message = ChatMessage.builder().chatRoom(ChatRoom.builder().id(1L).build())
