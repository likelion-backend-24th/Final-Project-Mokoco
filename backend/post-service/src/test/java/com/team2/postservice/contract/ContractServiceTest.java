...
class ContractServiceTest extends FlywaySchemaTest {
    ...
    @BeforeEach void setup() {
        ...
        roomId = 100L;
        when(payments.getPaymentByPostId(post.getId())).thenReturn(new com.team2.postservice.client.dto.PaymentClientResponse(1L, post.getId(), "COMPLETED", null, null, null, null));
    ...
    @Test void bothSignaturesRequiredBeforeRepairerCanStartAndRequesterCanAccept() {
        ...
        when(payments.getPaymentByPostId(anyLong())).thenReturn(new com.team2.postservice.client.dto.PaymentClientResponse(1L, 1L, "FAILED", null, null, null, null));
        assertThatThrownBy(() -> service.advance(roomId, 10L, contract.id(), "accept")).isInstanceOf(ResponseStatusException.class);
        when(payments.getPaymentByPostId(anyLong())).thenReturn(new com.team2.postservice.client.dto.PaymentClientResponse(1L, 1L, "COMPLETED", null, null, null, null));
