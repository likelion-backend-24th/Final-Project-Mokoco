...
public class AiResponseAdvice implements ResponseBodyAdvice<JsonNode> {
    ...
    @Override public JsonNode beforeBodyWrite(JsonNode body, MethodParameter returnType, MediaType contentType,
        ...
        if (body instanceof ObjectNode object) object.put("requestId",AiRequestTrace.requestId());
        return body;
    }
}
