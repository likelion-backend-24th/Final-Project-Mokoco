...
public class InternalPaymentController {
    ...
    public PaymentContext context(@PathVariable Long postId) {
        ...
        return new PaymentContext(postId, deal.getId(), deal.getRequesterId(), deal.getRequesterEmail(),
                proposal.getRepairerId(), proposal.getRepairerEmail(), proposal.getEstimatedPrice(), deal.getStatus().name());
    }
}
