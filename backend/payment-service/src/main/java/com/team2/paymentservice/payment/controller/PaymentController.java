...
public class PaymentController {
    ...
    public OrderResponse prepare(@RequestBody Prepare request, @AuthenticationPrincipal LoginUser user) {
        PaymentOrder order = paymentService.prepare(request.postId(), user.email());
    ...
    public ResponseEntity<Long> createPayment(@RequestBody PaymentRequestDto.Create request,
        ...
        Long paymentId = paymentService.createPayment(request, user.email());
    ...
    public ResponseEntity<PayeePaymentsResponseDto> getMyPayments(
        ...
        return ResponseEntity.ok(paymentService.getMyPayments(user.email(), pageable));
    }
    ...
    public ResponseEntity<PaymentResponseDto> getPayment(@PathVariable Long paymentId,
                                                          @AuthenticationPrincipal LoginUser user) {
        return ResponseEntity.ok(paymentService.getPayment(paymentId, user.email()));
    }
